...
````````````html
<ul><li>italic</li><li>[<em>named link</em>][some-url]</li><li><em>[named link][some-url]</em></li><li>[<em>named link</em>][some-url]</li><li><em>[named link][some-url]</em></li><li>bold</li><li>[<strong>named link</strong>][some-url]</li><li><strong>[named link][some-url]</strong></li><li>[<strong>named link</strong>][some-url]</li><li><strong>[named link][some-url]</strong></li><li>bold italic</li><li>[<strong>named link</strong>][some-url]</li><li><strong>[named link][some-url]</strong></li><li>[<strong>named link</strong>][some-url]</li><li><strong>[named link][some-url]</strong></li><li>[<em><strong>named link</strong></em>][some-url]</li><li>[<strong><em>named link</em></strong>][some-url]</li><li><strong><em>[named link][some-url]</em></strong></li><li>code</li><li>[<code>named link</code>][some-url]</li><li>code italic</li><li><em>[<code>named link</code>][some-url]</em></li><li>[<em><code>named link</code></em>][some-url]</li><li><em>[<code>named link</code>][some-url]</em></li><li>[<em><code>named link</code></em>][some-url]</li><li>code bold</li><li><strong>[<code>named link</code>][some-url]</strong></li><li>[<strong><code>named link</code></strong>][some-url]</li><li><strong>[<code>named link</code>][some-url]</strong></li><li>[<strong><code>named link</code></strong>][some-url]</li><li>code bold italic</li><li>[<strong><code>named link</code></strong>][some-url]</li><li><strong>[<code>named link</code>][some-url]</strong></li><li>[<strong><code>named link</code></strong>][some-url]</li><li><strong>[<code>named link</code>][some-url]</strong></li><li>[<em><strong><code>named link</code></strong></em>][some-url]</li><li>[<strong><em><code>named link</code></em></strong>][some-url]</li><li><strong><em>[<code>named link</code>][some-url]</em></strong></li></ul>
````````````
